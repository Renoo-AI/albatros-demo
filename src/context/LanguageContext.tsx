...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "booking.payment_online": "Paiement en ligne",
    "booking.payment_online_desc": "Acompte par carte bancaire (locales/internationales) ou postale (e-DINAR) via Konnect.",
    "booking.payment_onsite": "Paiement sur place / Manuel",
    "booking.payment_onsite_desc": "Réservation temporaire (valide 48h). Acompte à régler sur place en espèces ou chèque.",
    "booking.success_text_manuel": "Votre demande de réservation a été enregistrée en état temporaire. Vous disposez de 48 heures pour régler l'acompte sur place (espèces ou chèque) afin de confirmer définitivement votre date.",
  ...
  en: {
    ...
    "booking.payment_online": "Online Payment",
    "booking.payment_online_desc": "Deposit via bank card (local/international) or postal card (e-DINAR) via Konnect.",
    "booking.payment_onsite": "On-site / Manual Payment",
    "booking.payment_onsite_desc": "Temporary booking (valid for 48h). Deposit to be settled on-site in cash or by check.",
    "booking.success_text_manuel": "Your booking request has been registered in a pending state. You have 48 hours to settle the deposit on-site (cash or check) to permanently confirm your date.",
